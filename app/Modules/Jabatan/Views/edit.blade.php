...
<div class="page-inner">
    <div id="edit-jabatan" class="card">
...
<script>
    Vue.createApp({
        ...
        methods: {
            async fetchData() {
                const response = await httpClient.get("{!! url('jabatan') !!}/{{ $jabatan_id }}")
                this.jabatan = response.data.result
            ...
            async update() {
                try {
                    showLoading()
                    const response = await httpClient.put("{!! url('jabatan') !!}/{{ $jabatan_id }}",
                        this.jabatan)
                    hideLoading()
                    showToast({
